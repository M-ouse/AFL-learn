...
static void find_as(u8 *argv0)
{
  ...
  if (afl_path) //如果环境变量存在，设置as_path为afl_path
  {
...
int main(int argc, char **argv)
{
  ...
  find_as(argv[0]); //确定afl-as的路径

  edit_params(argc, argv); //类似一个wrapper做翻译的过程

  // gcc demo/demo.c -o demo/demo -B . -g -O3 -funroll-loops -D__AFL_COMPILER=1 -DFUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION=1
