  ...
  while (fgets(line, MAX_LINE, inf))
  {
    ...
    if (strstr(line, ":"))
    {
      ...
      if (line[0] == '.')
      {
        ...
        if ((isdigit(line[1]) || (clang_mode && !strncmp(line, "LBB", 3))) && R(100) < inst_ratio)
        {
...
{
  // ./as --64 -o /tmp/ccz7TPTv.o /tmp/cc6CcXau.s
  s32 pid;
  u32 rand_seed;
  int status;
  ...
  // as --64 -o /tmp/ccEbXqCy.o /tmp/.afl-11750-1650789475.s
  // debug
  int i = 0;
  while (as_params[i] != 0)
  {
